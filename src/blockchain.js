...
class Blockchain {
    ...
    requestMessageOwnershipVerification(address) {
        ...
        return new Promise((resolve) => {
            ...
            // The method return a Promise that will resolve with the message to be signed
            //<WALLET_ADDRESS>:${new Date().getTime().toString().slice(0,-3)}:starRegistry (private method getUTCTimestamp gets the timestamp)

            resolve(`${address}:${self._getUTCTimestamp()}:starRegistry`);
